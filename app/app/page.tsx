    ...
    <main className="min-h-screen overflow-hidden bg-[#0a0b12] text-white">
      <div className="mx-auto flex min-h-screen max-w-[1500px] gap-5 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="sticky bottom-4 z-10 mx-auto mt-8 flex w-fit items-center gap-1 rounded-2xl border border-white/10 bg-[#171824]/90 p-1.5 shadow-2xl shadow-black/30 backdrop-blur-xl"><button type="button" className="flex items-center gap-2 rounded-xl bg-[#7656ff] px-4 py-2.5 text-xs font-semibold"><Plus size={14} /> New session</button><button type="button" className="rounded-xl px-3 py-2.5 text-xs text-white/45 hover:bg-white/10">Library</button><button type="button" className="rounded-xl px-3 py-2.5 text-xs text-white/45 hover:bg-white/10">Progress</button></div>
        </div>
      </div>
    </main>
  )
